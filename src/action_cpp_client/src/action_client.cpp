...
#include "cpp_my_interfaces/action/fibonacci.hpp"
#include "rclcpp/rclcpp.hpp"
#include "rclcpp_action/rclcpp_action.hpp"
#include "rclcpp_components/register_node_macro.hpp"

namespace action_cpptest
{
class FibonacciActionClient : public rclcpp::Node
{
public:
    using Fibonacci = cpp_my_interfaces::action::Fibonacci;
...
RCLCPP_COMPONENTS_REGISTER_NODE(action_cpptest::FibonacciActionClient)
