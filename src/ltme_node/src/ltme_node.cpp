...
void LidarDriver::run()
{
  ...
  rclcpp::Service<cpp_my_interfaces::srv::QuerySerial>::SharedPtr query_serial_service = node_->create_service<cpp_my_interfaces::srv::QuerySerial>
    ("query_serial", std::bind(&LidarDriver::querySerialService, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<cpp_my_interfaces::srv::QueryFirmwareVersion>::SharedPtr query_firmware_service = node_->create_service<cpp_my_interfaces::srv::QueryFirmwareVersion>
    ("query_firmware_version", std::bind(&LidarDriver::queryFirmwareVersion, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<cpp_my_interfaces::srv::QueryHardwareVersion>::SharedPtr query_hardware_service = node_->create_service<cpp_my_interfaces::srv::QueryHardwareVersion>
...
bool LidarDriver::querySerialService(const std::shared_ptr<cpp_my_interfaces::srv::QuerySerial::Request> request,
                                     std::shared_ptr<cpp_my_interfaces::srv::QuerySerial::Response> response)
{
...
bool LidarDriver::queryFirmwareVersion(const std::shared_ptr<cpp_my_interfaces::srv::QueryFirmwareVersion::Request> request,
                                       std::shared_ptr<cpp_my_interfaces::srv::QueryFirmwareVersion::Response> response)
{
  std::unique_lock<std::mutex> lock(mutex_, std::try_to_lock);
  if (lock.owns_lock()) {
    std::string firmware_version;
...
bool LidarDriver::queryHardwareVersion(const std::shared_ptr<cpp_my_interfaces::srv::QueryHardwareVersion::Request> request,
                                       std::shared_ptr<cpp_my_interfaces::srv::QueryHardwareVersion::Response> response)
{
  std::unique_lock<std::mutex> lock(mutex_, std::try_to_lock);
  if (lock.owns_lock()) {
