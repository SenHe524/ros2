...
#include "cpp_my_interfaces/srv/query_serial.hpp"
#include "cpp_my_interfaces/srv/query_firmware_version.hpp"
#include "cpp_my_interfaces/srv/query_hardware_version.hpp"
...
private:
  bool querySerialService(const std::shared_ptr<cpp_my_interfaces::srv::QuerySerial::Request> request,
                          std::shared_ptr<cpp_my_interfaces::srv::QuerySerial::Response> response);
  bool queryFirmwareVersion(const std::shared_ptr<cpp_my_interfaces::srv::QueryFirmwareVersion::Request> request,
                            std::shared_ptr<cpp_my_interfaces::srv::QueryFirmwareVersion::Response> response);
  bool queryHardwareVersion(const std::shared_ptr<cpp_my_interfaces::srv::QueryHardwareVersion::Request> request,
